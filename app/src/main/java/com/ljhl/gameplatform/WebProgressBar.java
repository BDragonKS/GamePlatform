...
import com.longruan.mobile.appframe.utils.CalculationUtil;
...
public class WebProgressBar extends View {
    ...
    private void initAttr(AttributeSet attrs) {
        TypedArray array = mContext.obtainStyledAttributes(attrs, R.styleable.webprogress);
        mMax = array.getInt(R.styleable.webprogress_max, 10);
        mCurProgress = array.getInt(R.styleable.webprogress_progress, 0);
        mDefaultHeight = array.getInt(R.styleable.webprogress_progressHeight, 200);
        mColor = array.getColor(R.styleable.webprogress_progressColor, Color.parseColor("#0AC416"));
        array.recycle();
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (widthMode == MeasureSpec.EXACTLY) {
            ...
            mWidth = CalculationUtil.getInstance().dip2px(mContext, 300);
        ...
        if (heightMode == MeasureSpec.EXACTLY) {
            ...
            mHeight = CalculationUtil.getInstance().dip2px(mContext, mDefaultHeight);
        }
