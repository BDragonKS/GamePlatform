...
//        url = mSharedPreferences.getString("pref_server_address", Constants.CHECK_UPDATE_BASE_URL) + Constants.UPDATE_URL;
        url = "http://218.29.140.178:8082/hnnyApp/" + Constants.UPDATE_URL;
    }
    ...
    private void parseJson(String result) {
        try {
            //{"ret":1,"msg":"查询成功","data":{"url":"upload/content/hnny1.0.0.apk","versioncode":"3","message":"初始版本"}}
            JSONObject jsonObject = new JSONObject(result);
//            JSONArray jsonArray = new JSONArray(result);
            JSONObject obj = jsonObject.getJSONObject("data");
            String updateMessage = obj.getString(Constants.APK_UPDATE_CONTENT);
//            String apkUrl = mSharedPreferences.getString("pref_server_address", Constants.CHECK_UPDATE_BASE_URL) + obj.getString(Constants.APK_DOWNLOAD_URL);
            String apkUrl = "http://218.29.140.178:8082/hnnyApp/" + obj.getString(Constants.APK_DOWNLOAD_URL);
